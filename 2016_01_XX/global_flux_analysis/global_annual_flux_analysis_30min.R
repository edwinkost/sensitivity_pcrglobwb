...
# making charts
chart_precipitation                   <- ggplot(data = data_frame_complete, aes(x = year, y = precipitation                  )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_land_evaporation                <- ggplot(data = data_frame_complete, aes(x = year, y = land_evaporation               )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_total_evaporation               <- ggplot(data = data_frame_complete, aes(x = year, y = total_evaporation              )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_land_runoff                     <- ggplot(data = data_frame_complete, aes(x = year, y = land_runoff                    )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_total_runoff                    <- ggplot(data = data_frame_complete, aes(x = year, y = total_runoff                   )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_gw_recharge                     <- ggplot(data = data_frame_complete, aes(x = year, y = gw_recharge                    )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_gw_baseflow                     <- ggplot(data = data_frame_complete, aes(x = year, y = gw_baseflow                    )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_total_withdrawal                <- ggplot(data = data_frame_complete, aes(x = year, y = total_withdrawal               )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_desalination_withdrawal         <- ggplot(data = data_frame_complete, aes(x = year, y = desalination_withdrawal        )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_surface_water_withdrawal        <- ggplot(data = data_frame_complete, aes(x = year, y = surface_water_withdrawal       )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_total_gw_abstraction            <- ggplot(data = data_frame_complete, aes(x = year, y = total_gw_abstraction           )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_fossil_gw_abstraction           <- ggplot(data = data_frame_complete, aes(x = year, y = fossil_gw_abstraction          )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_non_fossil_gw_abstraction       <- ggplot(data = data_frame_complete, aes(x = year, y = non_fossil_gw_abstraction      )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_irrigation_withdrawal           <- ggplot(data = data_frame_complete, aes(x = year, y = irrigation_withdrawal          )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_non_irrigation_withdrawal       <- ggplot(data = data_frame_complete, aes(x = year, y = non_irrigation_withdrawal      )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_paddy_irrigation_withdrawal     <- ggplot(data = data_frame_complete, aes(x = year, y = paddy_irrigation_withdrawal    )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_non_paddy_irrigation_withdrawal <- ggplot(data = data_frame_complete, aes(x = year, y = non_paddy_irrigation_withdrawal)) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_industry_withdrawal             <- ggplot(data = data_frame_complete, aes(x = year, y = industry_withdrawal            )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_domestic_withdrawal             <- ggplot(data = data_frame_complete, aes(x = year, y = domestic_withdrawal            )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_livestock_withdrawal            <- ggplot(data = data_frame_complete, aes(x = year, y = livestock_withdrawal           )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_non_irrigation_consumption      <- ggplot(data = data_frame_complete, aes(x = year, y = non_irrigation_consumption     )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
chart_non_irrigation_return_flow      <- ggplot(data = data_frame_complete, aes(x = year, y = non_irrigation_return_flow     )) + geom_line() + theme(axis.text = element_text(size = 6), axis.title = element_text(size = 6.5, , vjust = -0.25, face = "bold"))
