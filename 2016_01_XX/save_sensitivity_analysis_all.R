...
names(average_values)[10] <- "calibration_avg_correlation"                                      
names(average_values)[11] <- "calibration_avg_R2"                                               
names(average_values)[12] <- "calibration_avg_R2_adjusted"                                      
names(average_values)[13] <- "calibration_lm_slope_obs_to_model"                                
names(average_values)[14] <- "calibration_avg_ns_efficiency"                                    
names(average_values)[15] <- "calibration_avg_ns_efficiency_log"                                
names(average_values)[16] <- "calibration_avg_kge_2009"                                         
names(average_values)[17] <- "calibration_avg_kge_2012"                                         
names(average_values)[18] <- "calibration_avg_correlation_per_baseflow_deviation_relative"      
names(average_values)[19] <- "calibration_avg_R2_per_baseflow_deviation_relative"               
names(average_values)[20] <- "calibration_avg_R2_adjusted_per_baseflow_deviation_relative"      
names(average_values)[21] <- "calibration_lm_slope_obs_to_model_per_baseflow_deviation_relative"
names(average_values)[22] <- "calibration_avg_ns_efficiency_per_baseflow_deviation_relative"    
names(average_values)[23] <- "calibration_avg_ns_efficiency_log_per_baseflow_deviation_relative"
names(average_values)[24] <- "calibration_avg_kge_2009_per_baseflow_deviation_relative"         
names(average_values)[25] <- "calibration_avg_kge_2012_per_baseflow_deviation_relative"         
names(average_values)[26] <- "validation_avg_correlation"                                      
names(average_values)[27] <- "validation_avg_R2"                                               
names(average_values)[28] <- "validation_avg_R2_adjusted"                                      
names(average_values)[29] <- "validation_lm_slope_obs_to_model"                                
names(average_values)[30] <- "validation_avg_ns_efficiency"                                    
names(average_values)[31] <- "validation_avg_ns_efficiency_log"                                
names(average_values)[32] <- "validation_avg_kge_2009"                                         
names(average_values)[33] <- "validation_avg_kge_2012"                                         
names(average_values)[34] <- "validation_avg_correlation_per_baseflow_deviation_relative"      
names(average_values)[35] <- "validation_avg_R2_per_baseflow_deviation_relative"               
names(average_values)[36] <- "validation_avg_R2_adjusted_per_baseflow_deviation_relative"      
names(average_values)[37] <- "validation_lm_slope_obs_to_model_per_baseflow_deviation_relative"
names(average_values)[38] <- "validation_avg_ns_efficiency_per_baseflow_deviation_relative"    
names(average_values)[39] <- "validation_avg_ns_efficiency_log_per_baseflow_deviation_relative"
names(average_values)[40] <- "validation_avg_kge_2009_per_baseflow_deviation_relative"         
names(average_values)[41] <- "validation_avg_kge_2012_per_baseflow_deviation_relative"
