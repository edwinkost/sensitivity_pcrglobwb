...
# make scatter plots
pdf("0Rtest.pdf", width=20, height=50, bg = "white")

par(mfrow=c(length(river), 4), mar=c(0.05,0.05,0.05,0.05))
...
plot(parameters$min_soil_depth_frac, array(i_river, length(parameters$code)), cex = kge_2009 * 4., ann=FALSE)
plot(parameters$log_ksat           , array(i_river, length(parameters$code)), cex = kge_2009 * 4., ann=FALSE)
plot(parameters$log_recession_coef , array(i_river, length(parameters$code)), cex = kge_2009 * 4., ann=FALSE)
plot(parameters$stor_cap           , array(i_river, length(parameters$code)), cex = kge_2009 * 4., ann=FALSE)
