...
# log_ksat should be equal to -0.25
parameters = parameters[which(parameters$log_ksat == -0.25), ]

# min_soil_depth_frac should not be equal to 1.00
parameters = parameters[which(parameters$min_soil_depth_frac == 1.00), ]

# log_recession_coef should be 0.00
parameters = parameters[which(parameters$log_recession_coef == 0.0), ]
