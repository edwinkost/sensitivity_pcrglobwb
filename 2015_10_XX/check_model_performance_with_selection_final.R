...
parameters = parameters[which(parameters$avg_recharge > 15000), ]
parameters = parameters[which(parameters$avg_recharge < 25000), ]

# average evaporation should be above 55000 km3/year
parameters = parameters[which(parameters$avg_evaporation > 55000), ]

# log_ksat should be between -0.5 and 0.5
parameters = parameters[which(parameters$log_ksat >= -0.5), ]
parameters = parameters[which(parameters$log_ksat <= 0.5), ]
...
plot(parameters$min_soil_depth_frac, parameters$avg_evaporation, xlim = c(0.5, 1.5))
abline(h = evaporation_ref)
plot(parameters$log_ksat           , parameters$avg_evaporation, xlim = c(-1, 1))
abline(h = evaporation_ref)
plot(parameters$log_recession_coef , parameters$avg_evaporation, xlim = c(-1, 1))
abline(h = evaporation_ref)
plot(parameters$stor_cap           , parameters$avg_evaporation, xlim = c(0.5, 1.5))
abline(h = evaporation_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_runoff, xlim = c(0.5, 1.5))
abline(h = runoff_ref)                                    
plot(parameters$log_ksat           , parameters$avg_runoff, xlim = c(-1, 1))
abline(h = runoff_ref)                                    
plot(parameters$log_recession_coef , parameters$avg_runoff, xlim = c(-1, 1))
abline(h = runoff_ref)                                    
plot(parameters$stor_cap           , parameters$avg_runoff, xlim = c(0.5, 1.5))
abline(h = runoff_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_baseflow, xlim = c(0.5, 1.5))
abline(h = baseflow_ref)                                    
plot(parameters$log_ksat           , parameters$avg_baseflow, xlim = c(-1, 1))
abline(h = baseflow_ref)                                    
plot(parameters$log_recession_coef , parameters$avg_baseflow, xlim = c(-1, 1))
abline(h = baseflow_ref)                                    
plot(parameters$stor_cap           , parameters$avg_baseflow, xlim = c(0.5, 1.5))
abline(h = baseflow_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_groundwater_recharge, xlim = c(0.5, 1.5))
abline(h = recharge_ref)                                                
plot(parameters$log_ksat           , parameters$avg_groundwater_recharge, xlim = c(-1, 1))
abline(h = recharge_ref)                                                
plot(parameters$log_recession_coef , parameters$avg_groundwater_recharge, xlim = c(-1, 1))
abline(h = recharge_ref)                                                
plot(parameters$stor_cap           , parameters$avg_groundwater_recharge, xlim = c(0.5, 1.5))
abline(h = recharge_ref)
