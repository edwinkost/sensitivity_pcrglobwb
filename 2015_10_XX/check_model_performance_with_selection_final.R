...
plot(parameters$log_ksat           , parameters$avg_evaporation)
abline(h = evaporation_ref)
plot(parameters$log_recession_coef , parameters$avg_evaporation)
abline(h = evaporation_ref)
plot(parameters$stor_cap           , parameters$avg_evaporation)
abline(h = evaporation_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_runoff)
abline(h = runoff_ref)                                    
plot(parameters$log_ksat           , parameters$avg_runoff)
abline(h = runoff_ref)                                    
plot(parameters$log_recession_coef , parameters$avg_runoff)
abline(h = runoff_ref)                                    
plot(parameters$stor_cap           , parameters$avg_runoff)
abline(h = runoff_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_baseflow)
abline(h = baseflow_ref)                                    
plot(parameters$log_ksat           , parameters$avg_baseflow)
abline(h = baseflow_ref)                                    
plot(parameters$log_recession_coef , parameters$avg_baseflow)
abline(h = baseflow_ref)                                    
plot(parameters$stor_cap           , parameters$avg_baseflow)
abline(h = baseflow_ref)

plot(parameters$min_soil_depth_frac, parameters$avg_groundwater_recharge)
abline(h = recharge_ref)                                                
plot(parameters$log_ksat           , parameters$avg_groundwater_recharge)
abline(h = recharge_ref)                                                
plot(parameters$log_recession_coef , parameters$avg_groundwater_recharge)
abline(h = recharge_ref)                                                
plot(parameters$stor_cap           , parameters$avg_groundwater_recharge)
abline(h = recharge_ref)
