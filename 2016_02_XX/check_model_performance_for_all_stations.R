...
chart_for_min_soil_depth_frac <- chart_for_min_soil_depth_frac + annotate("text", x = 1.75, y = river_number, label = substr(river_name[1], 1, 7), size = 2.00)
chart_for_log_ksat            <- chart_for_log_ksat            + annotate("text", x = 0.75, y = river_number, label = substr(river_name[1], 1, 7), size = 2.00)
chart_for_stor_cap            <- chart_for_stor_cap            + annotate("text", x = 1.75, y = river_number, label = substr(river_name[1], 1, 7), size = 2.00)
chart_for_log_recession_coef  <- chart_for_log_recession_coef  + annotate("text", x = 1.25, y = river_number, label = substr(river_name[1], 1, 7), size = 2.00)
